...
func main() {
	...
	steps := flag.String("steps", "3000", "comma-separated step values (ms)")
	lengths := flag.String("lengths", "8000", "comma-separated length values (ms)")
	keeps := flag.String("keeps", "200", "comma-separated keep values (ms)")
	acs := flag.String("acs", "0", "comma-separated ac values (0=default)")
