...
def main() -> int:
    ...
    parser.add_argument("--baseline-step", type=int, default=3000)
    parser.add_argument("--baseline-length", type=int, default=8000)
    parser.add_argument("--baseline-keep", type=int, default=200)
